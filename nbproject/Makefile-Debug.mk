...
# CC Compiler Flags
CCFLAGS=-std=c++11 -lboost_unit_test_framework
CXXFLAGS=-std=c++11 -lboost_unit_test_framework
...
${OBJECTDIR}/beginners_method.o: beginners_method.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beginners_method.o beginners_method.cpp

${OBJECTDIR}/cube.o: cube.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube.o cube.cpp

${OBJECTDIR}/cube_algorithms.o: cube_algorithms.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_algorithms.o cube_algorithms.cpp

${OBJECTDIR}/cube_generator.o: cube_generator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_generator.o cube_generator.cpp

${OBJECTDIR}/cube_logging.o: cube_logging.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_logging.o cube_logging.cpp

${OBJECTDIR}/method_steps.o: method_steps.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method_steps.o method_steps.cpp
...
${TESTDIR}/test_beginners_method.o: test_beginners_method.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_beginners_method.o test_beginners_method.cpp


${TESTDIR}/test_cube.o: test_cube.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_cube.o test_cube.cpp


${TESTDIR}/test_cube_algorithms.o: test_cube_algorithms.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_cube_algorithms.o test_cube_algorithms.cpp


${TESTDIR}/test_cube_generator.o: test_cube_generator.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_cube_generator.o test_cube_generator.cpp


${TESTDIR}/test_method_steps.o: test_method_steps.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_method_steps.o test_method_steps.cpp


${TESTDIR}/test_rcs.o: test_rcs.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_rcs.o test_rcs.cpp


${TESTDIR}/test_solve_random.o: test_solve_random.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_solve_random.o test_solve_random.cpp


${TESTDIR}/test_suite.o: test_suite.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_suite.o test_suite.cpp
...
${OBJECTDIR}/beginners_method_nomain.o: ${OBJECTDIR}/beginners_method.o beginners_method.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beginners_method_nomain.o beginners_method.cpp;\
	else  \
...
${OBJECTDIR}/cube_nomain.o: ${OBJECTDIR}/cube.o cube.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_nomain.o cube.cpp;\
	else  \
...
${OBJECTDIR}/cube_algorithms_nomain.o: ${OBJECTDIR}/cube_algorithms.o cube_algorithms.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_algorithms_nomain.o cube_algorithms.cpp;\
	else  \
...
${OBJECTDIR}/cube_generator_nomain.o: ${OBJECTDIR}/cube_generator.o cube_generator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_generator_nomain.o cube_generator.cpp;\
	else  \
...
${OBJECTDIR}/cube_logging_nomain.o: ${OBJECTDIR}/cube_logging.o cube_logging.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cube_logging_nomain.o cube_logging.cpp;\
	else  \
...
${OBJECTDIR}/method_steps_nomain.o: ${OBJECTDIR}/method_steps.o method_steps.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method_steps_nomain.o method_steps.cpp;\
	else  \
